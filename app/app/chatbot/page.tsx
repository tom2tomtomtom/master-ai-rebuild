        ...
        <div className="mb-8">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Master AI Assistant</h1>
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                  Your intelligent guide to AI mastery
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/browse"
                className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors border border-gray-200 dark:border-gray-800 hover:border-blue-300 dark:hover:border-blue-700"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-lg transition-colors border border-gray-200 dark:border-gray-800"
              >
